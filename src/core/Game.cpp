...
void Game::initializeMenu() {
    ...
    tutorialImageTexture = ResourceManager::loadTexture("assets/images/ui/tutorial.png", renderer); // Load ảnh hướng dẫn
...
void Game::renderTutorialScreen() {
    ...
    if (tutorialImageTexture) {
        SDL_Rect tutorialRect = {0, 0, WINDOW_WIDTH, WINDOW_HEIGHT};
        SDL_RenderCopy(renderer, tutorialImageTexture, nullptr, &tutorialRect);
    }
    ...
    renderText("BACK", WINDOW_WIDTH / 2 - 30, WINDOW_HEIGHT - BUTTON_HEIGHT - 10, SDL_Color{255, 255, 255, 255});
}
